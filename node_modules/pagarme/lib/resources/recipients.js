 ...
 *                             The page index.
 */
const all = (opts, body) => findAll(opts, body)
 ...
 */
const create = (opts, body) => request.post(opts, routes.recipients.base, body)
 ...
 *                    the request or to an error.
 */
const createKyc = (opts, body) =>
  request.post(opts, routes.recipients.kyc(body.id), body)
