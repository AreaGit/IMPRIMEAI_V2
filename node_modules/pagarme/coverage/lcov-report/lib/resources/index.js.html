...
import kyc from './kyc'
import payments from './payments'<span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" ></span></span></span>
&nbsp;
export default {
  company,
  companySegments,
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Thu Oct 06 2022 18:59:03 GMT-0300 (Horário Padrão de Brasília)
</div>
</div>
